...
import { IsArray, IsBoolean, IsDefined, IsLatitude, IsLongitude, IsNotEmpty, IsNotEmptyObject, IsNumber, IsObject, IsOptional, IsString, Matches, ValidateNested } from "class-validator";
