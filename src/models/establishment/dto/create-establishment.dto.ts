...
export class CreateEstablishmentDto {
    ...
    @IsNumber({ maxDecimalPlaces: 2 }, { message: HttpCustomMessages.VALIDATION.PRICE.INVALID })
    price: number;
    ...
    @IsBoolean({ message: HttpCustomMessages.VALIDATION.GROUND_FLOOR_ROOM.INVALID })
